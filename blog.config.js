...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '196ee09b3370804981f1ca6b01f13191',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '南湖儀隊', // 您的昵称 例如 tangly1024
  BIO:
    process.env.NEXT_PUBLIC_BIO ||
    '📌《活力▪︎團結▪︎創新》Since 2012🤝🏻｜活動邀約歡迎私訊小盒子💬✨', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://nhuhg.vercel.app', // 网站地址
  KEYWORDS:
    process.env.NEXT_PUBLIC_KEYWORD ||
    '儀隊,學生儀隊,Honor of Guard,南湖高中,Nan-Hu Senior High school', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Nan-Hu Honor of Guard<br>《 活力 》,Nan-Hu Honor of Guard<br>《 活力 ▪︎ 團結 》,Nan-Hu Honor of Guard<br>《 活力 ▪︎ 團結 ▪︎ 創新 》',
